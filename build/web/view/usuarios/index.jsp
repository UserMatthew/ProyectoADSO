                            ...
                            <div class="card-body">
                                <table id="tabla_usuarios" class="table table-bordered table-striped table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <center>
                                            <div class="btn-group">
                                                <a href="<%= request.getContextPath() %>/SrvtUsuario?action=update&id=${item.id}" type="button" class="btn btn-success"><i class="fa fa-pencil-alt"></i></a>
                                                <a href="<%= request.getContextPath() %>/SrvtUsuario?action=eliminar&id=${item.id}" class="btn btn-danger btn-delete-user">
    ...
    $(function () {
        $("#tabla_usuarios").DataTable({
            ...
            language: {
                ...
                "infoFiltered": "(Filtrado de _MAX_ _total_ Usuarios)",
                "infoPostFix": "",
                "thousands": ",",
