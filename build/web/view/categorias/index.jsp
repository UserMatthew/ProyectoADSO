...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Modulo Categorías
                   </h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                <table id="tabla_categorias" class="table table-bordered table-striped table-sm">
                                    ...
                                    <c:forEach items="${categoria}" var="item">
                                        ...
                                        <center>
                                            <div class="btn-group">
                                                <a href="<%= request.getContextPath() %>/SrvtCategoria?action=update&id=${item.id}" type="button" class="btn btn-success"><i class="fa fa-pencil-alt"></i></a>
                                                <a href="<%= request.getContextPath() %>/SrvtCategoria?action=eliminar&id=${item.id}" class="btn btn-danger btn-delete-user">
    ...
    $(function () {
        $("#tabla_categorias").DataTable({
            ...
            language: {
                ...
                "infoFiltered": "(Filtrado de _MAX_ _total_ Categorias)",
                "infoPostFix": "",
                "thousands": ",",
