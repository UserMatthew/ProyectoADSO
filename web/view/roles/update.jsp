                ...
                <div class="col-md-10">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Formulario de actualización de roles</h3>
                        </div>
                        <!-- /.card-header -->
                                ...
                                <div class="col-md-12">
                                    <form action="<%= request.getContextPath() %>/SrvtRol" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rol_nombre" class="form-control" value="${rol.nombre}" id="name" placeholder="Ingrese el nombre del rol" required>
                                        </div>
                                        <div class="form-group">
