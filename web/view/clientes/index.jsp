                                ...
                                <table id="tabla_clientes" class="table table-bordered table-striped table-sm">
                                    ...
                                    <center>
                                        <div class="btn-group">
                                            ...
                                            <a href="#" class="btn btn-danger btn-delete-client" data-id="123" data-toggle="modal" data-target="#confirmDeleteModal">
    ...
    $(function () {
        $("#tabla_clientes").DataTable({
            ...
            language: {
                ...
                "infoFiltered": "(Filtrado de _MAX_ _total_ Clientes)",
                "infoPostFix": "",
                "thousands": ",",
